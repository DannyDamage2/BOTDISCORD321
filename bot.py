...
""")
    await ctx.author.send("""
**p!play** : Play a song
**p!stop** : Stops the track
**p!queue** : See the following tracks
**p!skip** : Plays the next song
**p!pause** : Pause the track
**p!resume** : Unpause the track
**p!join** : Join a voice channel""")
...
async def on_message(message):
    if message.content.lower() == 'p!support' and message.author != bot.user:
